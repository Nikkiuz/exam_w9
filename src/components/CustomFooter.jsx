...
const CustomFooter = () => {
  return (
    <Container fluid className="bg-dark data-bs-theme-dark">
      <Row>
        <Col sm="6" className="justify-content-center align-content-center">
          <svg
          ...
          <svg
            className="me-2 bi bi-instagram"
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          ...
          <svg
            className="me-2 bi bi-twitter-x"
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <Col sm="6" md="3" bg="dark" data-bs-theme="dark">
          <ListGroup>
